...
declare class FlutterDriver extends BaseDriver<FluttertDriverConstraints> {
    ...
    proxydriver: XCUITestDriver | AndroidUiautomator2Driver;
    device: any;
    ...
    terminateApp(appId: string): Promise<any>;
    getOrientation(): Promise<string>;
    setOrientation(orientation: string): Promise<any>;
    ...
    proxyCommand(url: string, method: string, body?: null): Promise<any>;
