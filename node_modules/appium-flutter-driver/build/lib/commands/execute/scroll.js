...
const shouldRetry = (startAt, waitTimeoutMilliseconds) => {
    ...
    return Date.now() - startAt < lodash_1.default.toInteger(waitTimeoutMilliseconds);
};
const scrollUntilVisible = async (self, elementBase64, opts) => {
    ...
    (async () => {
        try {
            await (0, wait_1.waitFor)(self, item, waitTimeoutMilliseconds);
            isVisible = true;
        }
        catch (ign) { }
    })();
...
const scrollUntilTapable = async (self, elementBase64, opts) => {
    ...
    (async () => {
        try {
            await (0, wait_1.waitForTappable)(self, item, waitTimeoutMilliseconds);
            isVisible = true;
        }
        catch (ign) { }
    })();
